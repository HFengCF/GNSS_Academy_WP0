...
if __name__ == "__main__":
    ...
    chart = Charts(fill_data_fields(dict, path_name))

    # Filling data
    dataframe = chart.get_dataframe()
    ...
    chart.set_dataframe(df = dataframe)

    # ------------------------------------------------- T2 ----------------------------------------------------------------------------

    # chart.plot_scatterplot(x_column_name = 'Hour', y_column_name = 'PRN', color_bar_column_name = 'ELEV', y_div = 1, \
    ...
    # chart.plot_scatterplot(x_column_name = 'Hour', y_column_name = 'RANGE[m]', color_bar_column_name = 'ELEV', y_div = 1000, \
    ...
    # chart.plot_scatterplot_in_map(x_pos_column = 'SAT-X[m]', y_pos_column = 'SAT-Y[m]', z_pos_column = 'SAT-Z[m]', color_bar_column_name = 'ELEV', \
    ...
    # chart.plot_scatterplot(x_column_name = 'Hour', y_column_name = 'ABS_VEL', color_bar_column_name = 'ELEV', y_div = 1, \
    ...
    # chart.plot_scatterplot(x_column_name = 'Hour', y_column_name = 'TGD[m]', color_bar_column_name = 'PRN', y_div = 1, \
    ...
    # chart.plot_scatterplot(x_column_name = 'Hour', y_column_name = 'DTR[m]', color_bar_column_name = 'ELEV', y_div = 1, \
    ...
    # chart.plot_scatterplot(x_column_name = 'Hour', y_column_name = 'STEC[m]', color_bar_column_name = 'ELEV', y_div = 1, \
    ...
    # chart.plot_scatterplot(x_column_name = 'Hour', y_column_name = 'PRN', color_bar_column_name = 'STEC[m]', y_div = 1, \
    ...
    # chart.plot_scatterplot(x_column_name = 'Hour', y_column_name = 'VTEC[m]', color_bar_column_name = 'ELEV', y_div = 1, \
    ...
    # chart.plot_scatterplot(x_column_name = 'Hour', y_column_name = 'PRN', color_bar_column_name = 'VTEC[m]', y_div = 1, \
    ...
    # Zenith NOT GOOD
    chart.plot_scatterplot(x_column_name = 'Hour', y_column_name = 'ZTD', color_bar_column_name = 'ELEV', y_div = 1, \
                           default_x_ticks = False, default_y_ticks = True, title_plot = "Satellite Visibility vs VTEC", \
                           x_label_name = 'Hour of DoY', y_label_name = 'ZTD', color_bar_label_name = 'ELEV'
                           )